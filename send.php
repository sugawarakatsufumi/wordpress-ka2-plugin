...
$to = "sugawara-s@wako-sg.co.jp,n-hamada@wako-sg.co.jp,k.kikuchi@sanritsu-is.co.jp,miyata@wako-sg.co.jp,kawahara@wako-sg.co.jp,kouiki@wako-sg.co.jp,hozumi@wako-sg.co.jp,matsumoto@sanritsu-is.co.jp,nitou@sanritsu-is.co.jp,wakosg1970+wako@gmail.com,webmail@wako-sg.co.jp,nagashima@wako-sg.co.jp,head@wako-sg.co.jp,mitomo@wako-sg.co.jp,aizawa@wako-sg.co.jp,r-ozawa@wako-sg.co.jp,matsushita@wako-sg.co.jp,kengo-s@wako-sg.co.jp";
...
$require = array('担当者氏名','フリガナ','Email');
...
$refrom_name = "webmail@wako-sg.co.jp";
...
<?php @include "../include/meta_js_css.html"; ?>
<link rel="stylesheet" href="/css/inquiry.css">
</head>
<body>
<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KSHSX5F"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<!-- End Google Tag Manager (noscript) -->
<div class="wrp_h1"><h1>確認</h1></div>
...
<div class="wrp_h2">
	<div>
		...
		<p>弊社への各種お問い合わせはこちらより</p>
	</div>
</div>
<div class="wrp_main clearfix">
		...
		foreach($_POST as $key => $val) {
			if($key == $requireVal) {
				...
				if(is_array($val)){
					...
					if($connectEmpty > 0){
						$res['errm'] .= "<p class=\"error_messe\">【".h($key)."】required items.</p>\n";
						$res['empty_flag'] = 1;
					}
				}
				//デフォルト必須チェック
